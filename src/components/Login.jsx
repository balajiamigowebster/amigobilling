    ...
    <div className="login-container">
      ...
      <div className="login-left animate-fade-in">
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.2rem', fontWeight: 800, letterSpacing: '0.5px' }}>AMIGO</h2>
            <p style={{ fontSize: '0.75rem', letterSpacing: '1px', color: '#a78bfa' }}>WEBSTER</p>
          </div>
        </div>
        ...
        <div className="login-card animate-fade-in" style={{ animationDelay: '0.15s' }}>
          ...
          <div className="brand-header" style={{ textAlign: 'center', marginBottom: '32px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                <h2 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#fff' }}>AMIGO</h2>
                <p style={{ fontSize: '0.78rem', letterSpacing: '1px', color: '#a78bfa' }}>WEBSTER</p>
              </div>
            </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '28px' }}>
            <span style={{ fontSize: '0.78rem', color: '#475569', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
              <Sparkles size={12} style={{ color: '#8b5cf6' }} /> Powered by Amigo Webster
            </span>
          </div>
        </div>
      </div>
